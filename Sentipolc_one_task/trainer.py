...
class BertClsTrainer():
    def __init__(self) -> None:
        ...
        self.metric_positive = torchmetrics.MetricCollection({
            ...
            'accuracy' : torchmetrics.Accuracy(num_classes=num_classes, multiclass=False),
            'f1' : torchmetrics.F1Score(num_classes=num_classes, multiclass=False),
            'precision' : torchmetrics.Precision(num_classes=num_classes, multiclass=False),
            'recall' : torchmetrics.Recall(num_classes=num_classes, multiclass=False),
        }) 
