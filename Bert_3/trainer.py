...
class BertClsTrainer():
    def __init__(self) -> None:
        self.metric_collection = torchmetrics.MetricCollection({
            ...
            'f1_micro' : torchmetrics.F1Score(num_classes=3, multiclass=True, average='micro'),
            'f1_macro' : torchmetrics.F1Score(num_classes=3, multiclass=True, average='macro'),
            'f1_weighted' : torchmetrics.F1Score(num_classes=3, multiclass=True, average='weighted'),
            'f1_none' : torchmetrics.F1Score(num_classes=3, multiclass=True, average='none'),
