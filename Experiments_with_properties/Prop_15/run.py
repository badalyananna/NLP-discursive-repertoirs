...
if config['save']:
    model.push_to_hub("properties_15", use_temp_dir=True, use_auth_token=hf_token)
    AutoTokenizer.from_pretrained(model_name).push_to_hub("properties_15", use_temp_dir=True, use_auth_token=hf_token)
