...
rep['conferma'] = 6
rep['non risposta'] = 5
rep['contrapposizione'] = 3
rep['implicazione'] = 6
rep['giudizio'] = 3
rep['previsione'] = 5
rep['giustificazione'] = 6
rep['commento'] = 2
rep['generalizzazione'] = 5
rep['valutazione'] = 4
rep['dichiarazione di intenti'] = 6
rep['proposta'] = 6
rep['deresponsabilizzazione'] = 6
rep['prescrizione'] = 4
#rep['ridimensionamento'] = G + F + L + D + E + G + N
rep['ridimensionamento'] = 5
rep['considerazione'] = 6
rep['anticipazione'] = 6
