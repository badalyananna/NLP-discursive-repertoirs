...
if config['save']:
    model.push_to_hub("roberta_seg", use_temp_dir=True, use_auth_token=hf_token)
    train_dataset.tokenizer.push_to_hub("roberta_seg", use_temp_dir=True, use_auth_token=hf_token)
