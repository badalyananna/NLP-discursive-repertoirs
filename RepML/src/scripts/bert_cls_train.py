...
if config['save']:
    model.push_to_hub("roberta_disc_rep", use_temp_dir=True, use_auth_token=hf_token)
    AutoTokenizer.from_pretrained(model_name).push_to_hub("roberta_disc_rep", use_temp_dir=True, use_auth_token=hf_token)
